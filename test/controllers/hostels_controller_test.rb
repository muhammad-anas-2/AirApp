...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { h_name: @hostel.h_name, h_phone: @hostel.h_phone } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { h_name: @hostel.h_name, h_phone: @hostel.h_phone } }
