...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { c_name: @college.c_name, c_phone: @college.c_phone } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { c_name: @college.c_name, c_phone: @college.c_phone } }
